...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = '⁺◛˖Dykz ?'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'CyraBot '
        global.kontak2 = [
        ['6281384200380', 'Dykz OFC', '𝙿𝚎𝚗𝚐𝚎𝚖𝚋𝚊𝚗𝚐', 'Gak donasi Gak papa asal bantu Support Terus', true],
        ['6281384200380', await this.getName('6283890502148@s.whatsapp.net'), 'Partner Gw', true], 
        ]
